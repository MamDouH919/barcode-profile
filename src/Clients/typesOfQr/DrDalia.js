    ...
    return (
        <Root>
            ...
            <Stack className={classes.page} alignItems={"center"} >
                ...
                <Stack className={classes.fixRelative} width={"100%"} alignItems={"center"} spacing={2}>
                    <Typography variant='h1' textAlign={"center"} fontSize={35} textTransform={"capitalize"} px={3}>
                        {client.name}
                    </Typography>
                    {client.hashtag &&
                        <Stack mt={3}>
                    ...
                    {client.instaPay && <Stack className={classes.contentPaper} spacing={2} component={Paper} p={2}>
                        {client.consultation &&
                            <SocialCard to={`${client.consultation.link}`} type={"whatsApp"} title={client.consultation.name} color={client.color} />
                        }
                        {client.instaPay &&
                            <SocialCard to={`${client.instaPay.link}`} type={"instaPay"} title={client.instaPay.name} color={client.color} />
                        }
                    </Stack>}
                    ...
                    {client.branches && <Stack className={classes.contentPaper} spacing={2} component={Paper} p={2}>
